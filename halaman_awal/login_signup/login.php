			...
			<div class="row justify-content-md-center h-50">
				<div class="card-wrapper">
					<div class="brand mx-auto">
						<img src="login_signup/img/logonba.jpg" style="display:block" >
					</div>
					<div class="card fat">
						<div class="card-body">
							<h4 class="card-title">Masuk</h4>
							<form method="POST" class="my-login-validation" novalidate="" action="proses_login.php">
								...
								<div class="mt-4 text-center">
									Tidak punya akun? <a href="register.php">Buat satu</a>
								</div>
							</form>
						</div>
					</div>
